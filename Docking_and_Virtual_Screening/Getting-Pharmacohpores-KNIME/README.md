...
The input file is in csv format and presents a dataset with active molecules and in this case its characteristics include: inhibition constant (ec50, ic50 and Ki), id_CHEMBL, standard inchi/inchi-key and SMILES. (It can also have as inhibition constant pChEMBL which corresponds to -log in base 10 of the ec50, ic50 or ki constants).
 ...
 ![CSV-knime](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig_2.png) 
...
In addition they are separated by each type of inhibition that they present as already mentioned EC50, IC50, Ki and pChEMBL.
 ...
 <img src="/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig3.png" width="450" height="450">
...
For example, the figure shows that the SlogP of the molecule exceeds the allowed range (<=5), so a boolean=0 is assigned.
 ![Boolean_ROF](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig_15.png)
...
The molecules are grouped according to the chemical structural similarity between them and thus find groups that share a common scaffold. These molecules are identified with fingerprints in this case was carried out by Morgan FingerPrint and in the case of similarity can be described by the Tanimoto coefficient, which varies from zero to one, where values close to zero represent a low similarity and values close to 1 a high similarity.
 ...
 ![fingerprint-tanimoto](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig_4.png)
 Through the hierarchical clustering assigner node, the values obtained by the assigned threshold can be observed.
 
![nodo_graph](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig16.png)
...
![dendogram_clusters](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig_5.png)
...
<img src="/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig9.png" width="600" height="700">
...
<img src="/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig17.png" width="500" height="600">

The bar chart shows the population of molecules that make up each of the clusters formed for this group. 
![barchar_clusters](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig_6.png)
...
![graph_rof](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig18.png)
...
![rof_clusters](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig7.png)
![rof_clusters](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig8.png)
...
![end_result](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig10.png)
...
![file_pre_script](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig11.png)
...
![script_1](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig12.png)
...
![script_2](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig13.png)
...
![script_3](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig14.png)

Finally in the following figure you can see some of the pharmacophore hypotheses obtained at the end of the script 3.
![hypotheses](/Docking_and_Virtual_Screening/Getting-Pharmacohpores-KNIME/media/fig19.png)
